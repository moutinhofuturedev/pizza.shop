    ...
    <div className="flex h-screen flex-col items-center justify-center">
      <div className="mx-auto max-w-screen-xl px-4 py-8 max-md:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-sm text-center">
          <h1 className="mb-4 text-5xl font-extrabold tracking-tight max-lg:text-7xl">
            Whoops!404
          </h1>
          <p className="tracking-tigh mb-4 text-3xl font-bold dark:text-white max-lg:text-4xl">
